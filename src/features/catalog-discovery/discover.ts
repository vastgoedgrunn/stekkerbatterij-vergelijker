...
const RESEARCH_SEEDS: DiscoveredCandidate[] = [
  ...
  },
  {
    ...
    payload: {
      ...
      priceCheckedAt: "2026-07-31T05:05:41Z",
    },
  },
  {
    source: "research",
  ...
  {
    source: "research",
    externalId: "marstek-bol-venus-e-3",
    brandSlug: "marstek",
    rawTitle: "Marstek Venus E 3.0 5.12kWh",
    capacityKwh: 5.12,
    powerKw: 0.8,
    url: "https://www.bol.com/nl/nl/p/marstek-venus-e-3-0-5-12kwh-plug-play-thuisbatterij-via-230v-stopcontact/9300000240523865/",
    imageUrl: "/images/products/marstek-venus-512.jpg",
    priceCents: 130000,
    payload: {
      sourceTitle: "Marstek Venus E 3.0 Thuisbatterij 5,12kWh",
      priceCheckedAt: "2026-07-31T05:05:41Z",
    },
  },
  {
    source: "research",
    externalId: "marstek-jupiter-c-plus",
    brandSlug: "marstek",
    rawTitle: "Marstek Jupiter C Plus",
    rawDescription: "All-in-one plug-in balkonbatterij van 2,56 kWh, uitbreidbaar tot 10,24 kWh.",
    capacityKwh: 2.56,
    powerKw: 0.8,
    url: "https://eu.marstekenergy.com/nl-nl/products/marstek-jupiter-c-plus-all-in-one",
  ...
  },
  {
    ...
    priceCents: 139000,
    payload: {
      sourceTitle: "Sunology STOREY, 2200 Wh, 500 W",
      priceCheckedAt: "2026-07-31T05:05:41Z",
    },
  },
];
