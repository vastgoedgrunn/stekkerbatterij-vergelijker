...
Publieke productiecontrole op 2026-08-09 om 06:01 UTC. De automationomgeving heeft geen
...
- De zeven producten uit `0013_top_models_draft.sql` staan publiek, maar PLAY en NOAH 2000S
  ...
  seed-draft dat nog op publicatie wacht. Er is dus geen verifieerbare draft die op
  publicatiegoedkeuring wacht.

## Prijscontrole 2026-08-09

| Product | Productieprijs | Bronprijs | Actie |
|---------|---------------:|----------:|-------|
| Anker SOLIX Solarbank Max AC | EUR 2.199 | EUR 2.199 | Seed gecorrigeerd en bevestigd op 9 augustus |
| Zendure SolarFlow 800 plus AB2000L | EUR 747 | EUR 747 | Controletijdstip vernieuwd naar 9 augustus |
| HomeWizard Plug-In Battery | EUR 1.195 | EUR 1.195 | Controletijdstip vernieuwd naar 9 augustus |
| HomeWizard bundle | EUR 2.390 | EUR 2.390 | Afgeleid als twee bevestigde units |
| Sessy 5 kWh | EUR 3.550 | EUR 3.550 | Controletijdstip vernieuwd naar 9 augustus |
...
| EcoFlow STREAM AC Pro, merkshop | EUR 698 | EUR 749 | Seed bevestigd op 9 augustus, nog niet live |
| Sunology STOREY Master | EUR 2.499 | EUR 1.390 | Seed bevestigd op 9 augustus, nog niet live |
| Marstek Venus E 3.0 | EUR 1.300 | EUR 1.300 | Controletijdstip vernieuwd naar 9 augustus |
| Growatt NOAH 2000 | Geen offer | EUR 603,79 | Correctieseed bevestigd op 9 augustus, nog niet live |
...
De merchantprijzen zijn op 2026-08-09 om 06:04 UTC gecontroleerd. De exacte Bol-productpagina's
bevestigen Anker Max AC op EUR 2.199 en Marstek Venus E 3.0 op EUR 1.300:
...
- De code-equivalente productiecontrole over 11 bruikbare offerlinks geeft
