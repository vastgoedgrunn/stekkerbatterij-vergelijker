-- Bestaande offerprijzen opnieuw gecontroleerd op 2026-08-08T06:04:00Z.
-- Elke bevestigde merchantprijs wordt volledig automatisch verwerkt.
--
-- Anker Max AC, hard bevestigd op de Bol productpagina op 2026-08-08:
...
set
  ...
  affiliate_link_note = 'Bol productpagina EAN 0194644338664, EUR 2099, gecheckt 2026-08-08T06:04:00Z',
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
...
set
  price_cents = 74700,
  stock_status = 'in_stock',
  affiliate_link_note = 'Daisycon deeplink naar SolarFlow 800; Nederlandse setprijs EUR 747, gecheckt 2026-08-08T06:04:00Z',
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
from products p, merchants m
...
set
  ...
  affiliate_link_note = case
    when p.slug = 'homewizard-plug-in-battery-bundle'
      then 'HomeWizard merkshop, twee batterijen van EUR 1195; gecheckt 2026-08-08T06:04:00Z'
    else 'HomeWizard merkshop, EUR 1195; gecheckt 2026-08-08T06:04:00Z'
  end,
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
...
set
  price_cents = 355000,
  stock_status = 'in_stock',
  affiliate_link_note = 'Sessy prijsinformatie, 5 kWh EUR 3550; affiliate deeplink ontbreekt, plak deeplink zodra netwerk open is; gecheckt 2026-08-08T06:04:00Z',
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
from products p, merchants m
...
update offers o
set
  affiliate_link_note = 'De bron toont een Sessy 10 kWh-configuratie voor EUR 5500 zonder harde match met de bestaande Duo; prijs niet gewijzigd, affiliate deeplink ontbreekt, plak deeplink zodra netwerk open is; gecheckt 2026-08-08T06:04:00Z',
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
from products p, merchants m
...
set
  price_cents = 130000,
  stock_status = 'in_stock',
  affiliate_link_note = 'Bol productpagina 9300000240523865, EUR 1300, gecheckt 2026-08-08T06:04:00Z',
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
from products p, merchants m
...
set
  ...
  affiliate_link_note = 'EcoFlow merkshop actieprijs EUR 749; Awin deeplink ontbreekt, plak deeplink zodra netwerk open is; gecheckt 2026-08-08T06:04:00Z',
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
from products p, merchants m
...
set
  price_cents = 139000,
  stock_status = 'in_stock',
  affiliate_link_note = 'Sunology STOREY merkshop EUR 1390; affiliate deeplink ontbreekt, plak deeplink zodra netwerk open is; gecheckt 2026-08-08T06:04:00Z',
  affiliate_link_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  last_checked_at = '2026-08-08T06:04:00Z'::timestamptz,
  updated_at = now()
from products p, merchants m
