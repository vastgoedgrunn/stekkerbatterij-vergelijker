...
-- Gecontroleerd: 2026-08-06T18:03:41Z.
--
...
set
  ...
  affiliate_link_note = 'P0: zoek/listing/homepage of ontbrekende HTTPS outbound soft-deleted 2026-08-06',
  affiliate_link_checked_at = '2026-08-06T18:03:41Z'::timestamptz,
  last_checked_at = '2026-08-06T18:03:41Z'::timestamptz,
...
set
  ...
  affiliate_link_note = case
    when verified.merchant_slug = 'bol'
      then 'Avondcontrole 2026-08-06: Bol partnerlink 301 naar exact HTTPS productpad en product-ID'
    when verified.merchant_slug in ('homewizard', 'zendure')
      then 'Avondcontrole 2026-08-06: Daisycon-link geeft exact HTTPS productpad en SKU-match'
    else 'Avondcontrole 2026-08-06: directe product-URL geeft exact HTTPS productpad en SKU-match'
  end,
  affiliate_link_checked_at = '2026-08-06T18:03:41Z'::timestamptz,
  last_checked_at = '2026-08-06T18:03:41Z'::timestamptz,
  updated_at = now()
  ...
  from (
    values
      (
        ...
        'zendure',
        74700::bigint,
        'SolarFlow 800 plus AB2000L EUR 747 en Daisycon productpad gecontroleerd 2026-08-06',
        '2026-08-06T18:03:41Z'::timestamptz
      ),
      (
        'homewizard-plug-in-battery',
        'homewizard',
        119500::bigint,
        'HomeWizard merkshop EUR 1195 en Daisycon productpad gecontroleerd 2026-08-06',
        '2026-08-06T18:03:41Z'::timestamptz
      ),
      (
        ...
        'homewizard',
        239000::bigint,
        'HomeWizard merkshop, twee batterijen van EUR 1195, gecontroleerd 2026-08-06',
        '2026-08-06T18:03:41Z'::timestamptz
      ),
      (
        'sessy-thuisbatterij',
        'sessy',
        355000::bigint,
        'Sessy merkshop 5 kWh EUR 3550 en productconfigurator gecontroleerd 2026-08-06',
        '2026-08-06T18:03:41Z'::timestamptz
      ),
      (
        'sunology-storey',
        'sunology',
        139000::bigint,
        'Sunology STOREY EUR 1390 en exact productpad gecontroleerd 2026-08-06',
        '2026-08-06T18:03:41Z'::timestamptz
      )
