...
-- Gecontroleerd: 2026-08-04T18:04:50Z.
--
-- Zestien Bol partnerlinks gaven met een browserclient HTTPS 301 naar het
-- exacte productpad en product-ID.
-- Beide HomeWizard links en de Zendure link gaven via Daisycon HTTPS 200 op
-- het exacte productpad. Sessy gaf HTTPS 200 op de productconfigurator.
-- Sunology gaf opnieuw HTTP 429 en blijft pending.
--
-- Prijsbronnen:
...
-- P0: verwijder elke actieve zoekpagina, listing, homepage of niet HTTPS URL.
update offers
set
  stock_status = 'out_of_stock',
  affiliate_link_status = 'broken',
  affiliate_link_note = 'P0: zoek/listing/homepage of ontbrekende HTTPS outbound soft-deleted 2026-08-04',
  affiliate_link_checked_at = '2026-08-04T18:04:50Z'::timestamptz,
  last_checked_at = '2026-08-04T18:04:50Z'::timestamptz,
...
set
  ...
  affiliate_link_note = case
    when verified.merchant_slug = 'bol'
      then 'Avondcontrole 2026-08-04: Bol partnerlink 301 naar exact HTTPS productpad en product-ID'
    when verified.merchant_slug in ('homewizard', 'zendure')
      then 'Avondcontrole 2026-08-04: Daisycon-link geeft exact HTTPS productpad en SKU-match'
    else 'Avondcontrole 2026-08-04: directe product-URL geeft exact HTTPS productpad en SKU-match'
  end,
  affiliate_link_checked_at = '2026-08-04T18:04:50Z'::timestamptz,
  last_checked_at = '2026-08-04T18:04:50Z'::timestamptz,
  updated_at = now()
...
-- De Sunology bron is opnieuw niet betrouwbaar te controleren door rate limiting.
update offers o
set
  affiliate_link_status = 'pending',
  affiliate_link_note = 'Avondcontrole 2026-08-04: exacte STOREY URL gaf HTTP 429; opnieuw controleren',
  affiliate_link_checked_at = '2026-08-04T18:04:50Z'::timestamptz,
  last_checked_at = '2026-08-04T18:04:50Z'::timestamptz,
  updated_at = now()
  ...
  from (
    values
      (
        ...
        'zendure',
        74700::bigint,
        'SolarFlow 800 plus AB2000L EUR 747 en Daisycon productpad gecontroleerd 2026-08-04',
        '2026-08-04T18:04:50Z'::timestamptz
      ),
      (
        'homewizard-plug-in-battery',
        'homewizard',
        119500::bigint,
        'HomeWizard merkshop EUR 1195 en Daisycon productpad gecontroleerd 2026-08-04',
        '2026-08-04T18:04:50Z'::timestamptz
      ),
      (
        ...
        'homewizard',
        239000::bigint,
        'HomeWizard merkshop, twee batterijen van EUR 1195, gecontroleerd 2026-08-04',
        '2026-08-04T18:04:50Z'::timestamptz
      ),
      (
        'sessy-thuisbatterij',
        'sessy',
        355000::bigint,
        'Sessy merkshop 5 kWh EUR 3550 en productconfigurator gecontroleerd 2026-08-04',
        '2026-08-04T18:04:50Z'::timestamptz
      )
...
-- De Sessy configurator toont nog steeds 10 kWh voor EUR 5500.
