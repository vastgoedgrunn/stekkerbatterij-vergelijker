...
-- Gecontroleerd: 2026-07-31T18:49:42Z.
--
-- Outboundbronnen:
...
set
  ...
  affiliate_link_note = case
    when verified.merchant_slug = 'bol'
      then 'Avondcontrole 2026-07-31: Bol partnerlink 301 naar exacte HTTPS product-URL en SKU'
    when verified.merchant_slug in ('homewizard', 'zendure')
      then 'Avondcontrole 2026-07-31: Daisycon-link eindigt op HTTPS 200 en SKU-match'
    else 'Avondcontrole 2026-07-31: product-URL eindigt op HTTPS 200 en SKU-match'
  end,
  affiliate_link_checked_at = '2026-07-31T18:49:42Z'::timestamptz,
  last_checked_at = '2026-07-31T18:49:42Z'::timestamptz,
  updated_at = now()
from (
  ...
  from (
    values
      (
        'sunology-play',
        'sunology',
        'P0: URL verkoopt een PLAY zonnepaneelset zonder batterij-SKU; soft-deleted 2026-07-31'
      ),
      (
        'sessy-thuisbatterij-duo',
        'sessy',
        'P0: URL heeft geen specifieke Duo-SKU of Duo-prijs; soft-deleted 2026-07-31'
      )
...
set
  stock_status = 'out_of_stock',
  affiliate_link_note = 'P0: broken offer soft-deleted na avondcontrole 2026-07-31',
  affiliate_link_checked_at = '2026-07-31T18:49:42Z'::timestamptz,
  last_checked_at = '2026-07-31T18:49:42Z'::timestamptz,
  deleted_at = now(),
  updated_at = now()
  ...
  from (
    values
      (
        ...
        'bol',
        74900::bigint,
        'Bol productbron EUR 749 en partnerlink SKU-match; gecheckt 2026-07-31'
      ),
      (
        'anker-solix-solarbank-max-ac',
        'bol',
        209900::bigint,
        'Bol productbron EUR 2099 en partnerlink SKU-match; gecheckt 2026-07-31'
      ),
      (
        'sunology-storey',
        'sunology',
        139000::bigint,
        'Officiele STOREY productbron EUR 1390 en HTTPS titelmatch; gecheckt 2026-07-31'
      )
