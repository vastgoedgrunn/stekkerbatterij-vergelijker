...
2. Classify the change:
   ...
   C) New product / merchant / offer                            → SLACK APPROVAL
   D) New/changed factual claim (saldering, subsidy, rule, ...)  → SLACK APPROVAL
   E) Cannot find a citable source                              → DO NOT PUBLISH; ask in Slack
